...
function shell.init()
    ...
    shell.icons.env.no_wifi_icon = images.importSpriteFile("system/resources/sprites/no-wifi_icon.spr")
    shell.icons.env.iconNotFound = images.importSpriteFile("system/resources/sprites/iconNotFound.spr")

    shell.icons.env.loaderIcon = {frames = {}}
    shell.icons.env.loaderIcon.frames = {
        images.importSpriteFile("system/resources/sprites/animatedIcons/loaderIcon1.spr"),
        images.importSpriteFile("system/resources/sprites/animatedIcons/loaderIcon2.spr"),
        images.importSpriteFile("system/resources/sprites/animatedIcons/loaderIcon3.spr"),
        images.importSpriteFile("system/resources/sprites/animatedIcons/loaderIcon4.spr")
    }
end
